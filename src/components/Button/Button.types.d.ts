 ...
 */
export type ButtonIcon = '' | 'plus' | 'replace' | 'search' | 'split' | 'link' | 'edit' | 'product' | 'variant' | 'collection' | 'select' | 'info' | 'incomplete' | 'complete' | 'color' | 'money' | 'adjust' | 'affiliate' | 'airplane' | 'alert-bubble' | 'alert-circle' | 'alert-diamond' | 'alert-location' | 'alert-octagon' | 'alert-octagon-filled' | 'alert-triangle' | 'duplicate' | 'view' | 'menu-horizontal' | 'order';
/**
