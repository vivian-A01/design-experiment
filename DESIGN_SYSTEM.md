...
## Changelog (V2.0.0)
- **Button Radius**: Changed from 100% (fully rounded) to 8px (pill-style)
- **Primary CTA Color**: Updated to #ACFF19 (brighter green)
- **Highlight Color**: Updated to #5A912B (neon green for text highlights)
- **Menu Button**: New dark variant with #191919 background
- **Responsive System**: Mobile-first with fluid typography and spacing using clamp()
- **Full-width Layout**: Navigation bar spans 100vw on all screen sizes
...
/* Accent Lime/Green - UPDATED V2 */
--color-accent-primary: #ACFF19;  /* Primary CTA Green (V2) */
--color-accent-50: #F7FFCC;
--color-accent-100: #EFFF99;
--color-accent-200: #E7FF66;
--color-accent-300: #DFFF33;
--color-accent-400: #ACFF17;  /* Neon Lime */
--color-accent-500: #82C621;
--color-accent-600: #5A912B;  /* Highlight green */
...
/* Dark Theme Surfaces - UPDATED V2 */
--color-surface-primary: #000000;    /* Pure black background (V2) */
--color-surface-secondary: #191919;  /* Menu buttons (V2) */
...
### Component Radius Tokens - UPDATED V2

```css
--radius-button: 8px;                      /* Pill-style buttons (V2) - changed from 100% */
--radius-pill: 8px;                        /* Standard pill shape (V2) */
--radius-input: var(--radius-base);        /* 8px */
--radius-card: var(--radius-lg);           /* 16px */
--radius-modal: var(--radius-xl);          /* 24px */
--radius-badge: var(--radius-full);        /* Circular badges */
```

**V2 Change:** All buttons now use 8px radius (pill-style) instead of 100% (fully rounded). This creates a more modern, consistent pill-shaped appearance across all button types.
...
#### Primary Button - UPDATED V2
```css
.btn-primary {
  background: var(--color-accent-primary);  /* #ACFF19 (V2) */
  color: var(--color-text-inverse);         /* Black text */
  font-size: var(--font-size-base);
  font-weight: var(--font-weight-medium);
  padding: var(--space-3) var(--space-6);   /* 12px 24px */
  border-radius: 8px;                       /* Pill-style (V2) - was 100% */
  border: none;
  cursor: pointer;
...
.btn-primary:hover {
  ...
  transform: translate3d(0, -2px, 0) scale3d(1.02, 1.02, 1);  /* 3D transform (V2) */
...
#### Secondary Button - UPDATED V2
```css
.btn-secondary {
  background: var(--color-neutral-0);       /* White filled (V2) */
  color: var(--color-text-inverse);         /* Black text (V2) */
  border: none;                             /* No border (V2) */
  padding: var(--space-3) var(--space-6);
  border-radius: 8px;                       /* Pill-style (V2) */
  cursor: pointer;
  transition: all 0.2s ease;
}

.btn-secondary:hover {
  background: #F5F5F5;                      /* Light gray hover (V2) */
...
```css
.btn-dark {
  background: #191919;                      /* Dark gray (V2) */
